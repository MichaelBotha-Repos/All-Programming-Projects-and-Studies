'''
Create the Dog class with attributes for name and breed.
Then create a list of five dogs according to the following table:
Dog	Name	Breed
...
for details in dogs:
    print(details.name + '--->' + details.breed)
