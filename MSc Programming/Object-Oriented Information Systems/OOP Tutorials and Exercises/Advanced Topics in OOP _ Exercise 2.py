...
You have been given the class Band.
Extend the class such that it will produce specific output when using the print and repr.
...
class Band:
    ...
    def __str__(self):
        return (str(self.name) + " is a " + str(self.genre) + " band")

    def __repr__(self):
        return ('( ' + type(self).__name__ + ', ' + self.genre + ', ' + str(self.members) + ')')
